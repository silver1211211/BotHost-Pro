...
<div>
    ...
    <div class="relative mt-3">
        <span class="pointer-events-none absolute inset-y-0 left-3.5 flex items-center">
            <svg class="h-4 w-4 text-[#94A3B8]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 7.5l3 2.25-3 2.25m4.5 0h3m-9 8.25h13.5A2.25 2.25 0 0 0 21 18V6a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 6v12a2.25 2.25 0 0 0 2.25 2.25Z"/></svg>
        </span>
...
<div>
    ...
    <div class="relative mt-3" @click.away="triggerTypeOpen = false">
        ...
        <button type="button" @click="triggerTypeOpen = !triggerTypeOpen" class="flex w-full items-center justify-between rounded-xl border bg-[#11101C] px-4 py-3 text-sm text-[#F8FAFC] transition focus:outline-none" :class="triggerTypeOpen ? 'border-[#8B5CF6]/60 ring-2 ring-[#8B5CF6]/20' : 'border-[#27213D]'">
            ...
            <svg class="ml-2 h-4 w-4 shrink-0 text-[#94A3B8] transition-transform" :class="triggerTypeOpen ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5"/></svg>
        </button>
    ...
    <p class="mt-2 text-xs leading-relaxed text-[#94A3B8]" x-show="triggerType !== 'direct_message'">
        Runs when the user sends a command such as /start, /help, /menu, or /admin.
    </p>
    <p class="mt-2 text-xs leading-relaxed text-[#94A3B8]" x-show="triggerType === 'direct_message'" x-cloak>
...
<div class="grid gap-5 sm:grid-cols-2">
    <div>
        ...
        <p class="mt-1 text-xs text-[#94A3B8]">Optional. Separate up to 10 aliases with commas or new lines.</p>
    ...
    <div>
        ...
        <p class="mt-1 text-xs text-[#94A3B8]">Optional placeholder for future folder organization.</p>
...
<div>
    ...
    <p class="mt-1 text-xs text-[#94A3B8]">Optional display fallback for simple text responses.</p>
